...
\begin{itemize}
    ...
    \item The main task of the tech-volunteers were to help session chairs and authors to seamlessly navigate the conference platforms. The tech-chairs were only a stand-by options for worst case scenarios - when admin access was required to make changes to the platform or if the tech-volunteer couldn't make it to the session.
    \item As the tech-volunteers we recruited 3-4 students~\ref{sssec:vol} across each of the three timezones, that roughly corresponds to Asia, Europe and US timezones. We had 12 volunteers in total.
